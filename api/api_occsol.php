...
*/
$sql= "SELECT nom,code,superficie,label,ST_asgeojson(st_transform((geom),4326)) as geojson FROM surface2";
//$sql = "select ST_AsGeoJSON(geom) as geojson ,nom,code,structure,Label FROM surface2";
$rs = $conn->query($sql);
if (!$rs) {
    echo 'Erreur SQL.\n';
    exit;
